...
// include: /tmp/tmpc4v6s0qa.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build/web/release/index.data';
...
Module['FS_createPath']("/res", "shaders", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_build/web/release/index.data');

      };
      Module['addRunDependency']('datafile_build/web/release/index.data');
    ...
    loadPackage({"files": [{"filename": "/res/img/title_text.png", "start": 0, "end": 1161}, {"filename": "/res/music/no_stopping_now.ogg", "start": 1161, "end": 2774037, "audio": 1}, {"filename": "/res/music/title_theme.ogg", "start": 2774037, "end": 5664122, "audio": 1}, {"filename": "/res/music/win_theme.ogg", "start": 5664122, "end": 6699410, "audio": 1}, {"filename": "/res/sfx/click.ogg", "start": 6699410, "end": 6711492, "audio": 1}, {"filename": "/res/sfx/grab.ogg", "start": 6711492, "end": 6734011, "audio": 1}, {"filename": "/res/shaders/blur.frag", "start": 6734011, "end": 6734533}, {"filename": "/res/shaders/vignette.frag", "start": 6734533, "end": 6735060}], "remote_package_size": 6735060});

  })();

// end include: /tmp/tmpc4v6s0qa.js
// include: /tmp/tmpwf4mozz9.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpwf4mozz9.js
// include: /tmp/tmpsz_827hl.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach(function(task) {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpsz_827hl.js
...
var ASM_CONSTS = {
  131400: () => { if (document.fullscreenElement) return 1; },  
 131446: () => { return document.getElementById('canvas').width; },  
 131498: () => { return parseInt(document.getElementById('canvas').style.width); },  
 131566: () => { document.exitFullscreen(); },  
 131593: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 131666: () => { if (document.fullscreenElement) return 1; },  
 131712: () => { return document.getElementById('canvas').width; },  
 131764: () => { return screen.width; },  
 131789: () => { document.exitFullscreen(); },  
 131816: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 131949: () => { return window.innerWidth; },  
 131975: () => { return window.innerHeight; },  
 132002: () => { if (document.fullscreenElement) return 1; },  
 132048: () => { return document.getElementById('canvas').width; },  
 132100: () => { return parseInt(document.getElementById('canvas').style.width); },  
 132168: () => { if (document.fullscreenElement) return 1; },  
 132214: () => { return document.getElementById('canvas').width; },  
 132266: () => { return screen.width; },  
 132291: () => { return window.innerWidth; },  
 132317: () => { return window.innerHeight; },  
 132344: () => { if (document.fullscreenElement) return 1; },  
 132390: () => { return document.getElementById('canvas').width; },  
 132442: () => { return screen.width; },  
 132467: () => { document.exitFullscreen(); },  
 132494: () => { if (document.fullscreenElement) return 1; },  
 132540: () => { return document.getElementById('canvas').width; },  
 132592: () => { return parseInt(document.getElementById('canvas').style.width); },  
 132660: () => { document.exitFullscreen(); },  
 132687: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 132745: () => { return screen.width; },  
 132770: () => { return screen.height; },  
 132796: () => { return window.screenX; },  
 132823: () => { return window.screenY; },  
 132850: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 132903: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 132974: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 133031: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 133287: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 133358: () => { if (document.fullscreenElement) return 1; },  
 133404: () => { return window.innerWidth; },  
 133430: () => { return window.innerHeight; },  
 133457: () => { if (document.pointerLockElement) return 1; },  
 133504: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 135662: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 135826: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 135930: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 136101: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(Module.HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == miniaudio.device_type.playback || deviceType == miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return miniaudio.track_device(device); },  
 138929: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 138995: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 139388: ($0) => { miniaudio.untrack_device_by_index($0); },  
 139431: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 139556: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
function mouse_in_canvas() { return mouse_in_canvas_flag ? 1 : 0; }
